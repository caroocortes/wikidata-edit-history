...
class DumpParser(ContentHandler):
    def __init__(self):
    ...
    def endElement(self, name):
        ...
        if name == 'revision' and self.keep: # end of revision and we keep the entity
            ...
            if not current_revision:
                ...
                end_time = time.time()
                print(f'Time it took to process revision {self.revision_meta['revision_id']}: {end_time - start_time} seconds')
