...
CREATE TABLE IF NOT EXISTS entity_stats_sa (
    ...
    total_parse_time_sec FLOAT,
    avg_diff_calc_per_revision_sec FLOAT,
    avg_diff_calc_per_revision_msec FLOAT,
    file_path TEXT
);
...
CREATE TABLE IF NOT EXISTS features_text (
    ...
    special_chars_added INT,
    special_chars_removed INT,
    only_special_char_change INT,
